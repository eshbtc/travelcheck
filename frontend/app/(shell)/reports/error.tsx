...
/**
 * Error boundary for the reports section.
 * Catches errors in reports routes and provides a contextual recovery UI.
 */
export default function ReportsError({
  ...
  useEffect(() => {
    ...
    errorHandler.handleError(error, 'reports-error-boundary')
    ...
    <div className="p-8 max-w-2xl mx-auto">
      <div className="bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-800 rounded-lg p-6">
        ...
        <p className="text-red-700 dark:text-red-300 mb-4">
          {error.message || 'An error occurred while generating or loading your report.'}
        </p>
        {error.digest && (
